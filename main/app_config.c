...
provision_type_t provision_type = PROVISION_SMARTCONFIG;
...
bool is_provisioned(void)
{
    ...
    wifi_config_t wifi_config;
    esp_wifi_get_config(WIFI_MODE_STA, &wifi_config);
...
void ap_start(void)
{
    wifi_config_t wifi_config = {
        .ap = {
            .ssid = "PHANDUCMANH",
            .ssid_len = strlen((char *)"PHANDUCMANH"),
            .channel = 1,
            .password = "123456789",
            .max_connection = 4,
    ...
    ESP_ERROR_CHECK(esp_wifi_set_mode(WIFI_MODE_AP)); // set mode
